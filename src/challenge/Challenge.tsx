...
class Challenge extends React.Component<ChallengeProps, ChallengeState> {
    ...
    renderEditor() {
        return (<PyEditor ref={this.editorRef} 
            ...
            onDebug={() => {ChallengeController["debug"](this, {code: this.editorRef.current?.getValue(), breakpoints: this.editorRef.current ? this.editorRef.current.getBreakpoints() : []})}}
            onContinue={() => ChallengeController["continue"](this, {})}
            onStepInto={() => ChallengeController["step"](this)}
            onStop={() => { ChallengeController["restart-worker"](this, {msg: "Interrupted...", force: true})}}
            />)
    }
    ...
    renderConsole = () => {
        return (<Console 
            ...
            onInput={(input) => {ChallengeController["input-entered"](this, {input})}}
            onInterrupt={() => { ChallengeController["restart-worker"](this, {msg: "Interrupted...", force: true})}}/>)
    }
            ...
            <Card sx={{overflow: "visible"}}>
                <CardContent>
                    <MainControls
                        ...
                        onDebug={() => { ChallengeController["debug"](this, {code: this.editorRef.current?.getValue(), breakpoints: this.editorRef.current ? this.editorRef.current.getBreakpoints() : []})}}
                        onSubmit={() => { ChallengeController["test"](this, {code: this.editorRef.current?.getValue(), tests: this.props.tests})}}
    ...
    renderDebugPane = () => {
        return (<DebugPane 
            ...
            onKill={() => { ChallengeController["restart-worker"](this, {msg: "Interrupted...", force: true})}}
            debugContext={this.state.debugContext}/>)
    }
