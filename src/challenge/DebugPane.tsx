                ...
                <Grid container spacing={2} sx={{ mt: 0.5 }}>
                    ...
                    <Grid item>
                        <Button variant="contained" color="primary" 
                            disabled={ !props.canContinue } 
                            onClick={props.onStep }>Step to next line</Button>
                    </Grid>
                    <Grid item><Button variant="contained" color="error" 
                        disabled={ !props.canKill }
                        onClick={ props.onKill }>Stop</Button>
                    </Grid>
                </Grid>
            </Paper>
            ...
            { props.canContinue ?
                <StyledTable>
                    <TableContainer sx={{ height: "100%", overflowY: "scroll" }}>
                        <Table className="vartable" size="small" stickyHeader style={{ marginTop: 0}}>
                        <TableHead>
                            <TableRow>
                        ...
                        <TableBody>
                            {Array.from(props.debugContext.env.keys()).map((key) => (
                                <TableRow key={key} hover>
                                    ...
                                    <TableCell align="right">{props.debugContext.env.get(key)}</TableCell>
                                </TableRow>
                            ))}
                        </TableBody>
                        </Table>
